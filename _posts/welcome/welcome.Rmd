...
$$
The scaling factor $\sqrt{D_q}$ prevents extreme values in the Softmax, improving numerical stability. The resulting matrix $A$ is the *attention matrix* containing the attention weights $A_{nm}$. 
